...
export function CollectionFormView({ jobId, readOnly = true }: { jobId: string, readOnly?: boolean }) {
  ...
  if (!formData) return <div className="text-center py-12">No collection form found.</div>;
  ...
  return (
    <Card className="max-w-2xl mx-auto my-8">
      <CardContent className="space-y-4">
        ...
        <div><Label>Vehicle Collection Pack:</Label> {formData.vehicleCollectionPack ? 'Yes' : 'No'}</div>
